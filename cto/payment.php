        ...
        <div class="col-lg-6 ">
            <div class="card2">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                    <tr>
                        <td class="col-md-9"><em>Crypto-price watcher</em></td>
                ...
                <div class="card2" style="width: 80%">
                    <div class="card-header" style="background: white">
                        <div class="row">
                            ...
                            <img style="height: 50px" class="img-fluid cc-img"
                    ...
                    <div class="card-footer" style="background: white">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <button class="btn  btn-lg btn-block btn btn-warning" type="submit">Process payment
                                </button>
                            </div>
                        </div>
                    </div>
